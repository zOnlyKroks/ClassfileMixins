package de.zonlykroks.classfilemixins.transformer;
...
import static de.zonlykroks.classfilemixins.delegator.DelegatingClassLoader.getClassBytes;
...
public class ClassFileTransformerImpl {
    ...
    private final LookupSwitchCaseAdditionProcessor ModifySwitchStatementAnnotationProcessor = new LookupSwitchCaseAdditionProcessor();
    private final TableSwitchCaseAdditionProcessor TableSwitchCaseAdditionProcessor = new TableSwitchCaseAdditionProcessor();
        ...
        for(Method method : transformerClassModel.getMethods()) {
            ...
            for(Annotation annotation : method.getAnnotations()) {
                switch (annotation) {
                    ...
                    case LookupSwitchCaseAddition modifySwitchStatement -> targetModel = ModifySwitchStatementAnnotationProcessor.processAnnotation(modifySwitchStatement, targetModel, transformerModel, model);
                    case TableSwitchCaseAddition tableSwitchCaseAddition -> targetModel = TableSwitchCaseAdditionProcessor.processAnnotation(tableSwitchCaseAddition, targetModel, transformerModel, model);
                    default -> {
